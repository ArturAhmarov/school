...
if($ar_res = $ar_id_student->GetNextElement()){
    ...
    $id_s = $arProp['id_student']["VALUE"];
    $id_class = $arProp['id_class']["VALUE"];
    $subject= $arProp['subject']['VALUE'];
    $grade = $arProp['grade']['VALUE'];
}
?>
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="crud">
                ...
                <form name="add"  method="POST">
                    <p>Предмет</p>
                    <input type="text" name="subject" maxlength="255" required value="<?=$subject?>">
                    <p>Оценка</p>
                    <input type="number" name="grade" maxlength="1" required value="<?=$grade?>">
